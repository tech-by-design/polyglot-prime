...
FII: TC-0094
groupId: GRP-008
title: Verify that the payload is displayed for the techByDesignDisposition interaction when a CSV zip file is placed in the ingress folder via sftp
...
techByDesignDisposition interaction when a CSV zip file is placed in the ingress
folder via sftp.
