...
class TabularRowsControllerTest {
    ...
    @Mock
    private UdiPrimeJpaConfig udiPrimeJpaConfig;  // Mock any other dependencies
    ...
    ///
    @Test
    void testGetSubmissionCountsBetweenDates_SQLInjectionAttempt_SchemaName() {
        String schemaName = "validSchema'; DROP TABLE users; --"; // SQL injection attempt in schema name
        String viewName = "validView";
        String columnName1 = "validColumn1";
        String columnValue1 = "validValue1";
        String dateField = "validDateField";
        String startDateTimeValue = "10-10-2023 00:00:00";
        String endDateTimeValue = "10-11-2023 23:59:59";

        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, ()
                -> tabularRowsController.getSubmissionCountsBetweenDates(schemaName, viewName, columnName1, columnValue1, dateField, startDateTimeValue, endDateTimeValue));
        assertEquals("Invalid schema or table or column name.", exception.getMessage());
    }

    @Test
    void testGetSubmissionCountsBetweenDates_SQLInjectionAttempt_ViewName() {
        String schemaName = "validSchema";
        String viewName = "validView'; DROP TABLE users; --"; // SQL injection attempt in view name
        String columnName1 = "validColumn1";
        String columnValue1 = "validValue1";
        String dateField = "validDateField";
        String startDateTimeValue = "10-10-2023 00:00:00";
    ...
    @Test
    void testGetSubmissionCountsBetweenDates_SQLInjectionAttempt_ColumnName1() {
        String schemaName = "validSchema";
        String viewName = "validView";
        String columnName1 = "validColumn1'; DROP TABLE users; --"; // SQL injection attempt in column 1 name
        String columnValue1 = "validValue1";
    ...
    @Test
    void testGetSubmissionCountsBetweenDates_SQLInjectionAttempt_DateField() {
        String schemaName = "validSchema";
        String viewName = "validView";
        String columnName1 = "validColumn1";
        String columnValue1 = "validValue1";
        String dateField = "validDateField'; DROP TABLE users; --"; // SQL injection attempt in date field
        String startDateTimeValue = "10-10-2023 00:00:00";
        String endDateTimeValue = "10-11-2023 23:59:59";
