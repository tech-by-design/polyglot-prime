...
```<first-name>_<lst-name>_<family-name>_<bundle-id>.json```
...
The generated files will be in the `output/fhir` folder and copy the json with  file name format ```<first-name>_<lst-name>_<family-name>_<bundle-id>.json``` into  `happy-path` folder.

```
cp output/fhir/<first-name>_<lst-name>_<family-name>_<bundle-id>.json [path-to-polyglot-prime]/hub-prime/src/test/resources/org/techbd/fixtures/happy-path
```
...
```
cp <first-name>_<lst-name>_<family-name>*.json [path-to-polyglot-prime]/hub-prime/src/test/resources/org/techbd/fixtures/uphappy-path
```
