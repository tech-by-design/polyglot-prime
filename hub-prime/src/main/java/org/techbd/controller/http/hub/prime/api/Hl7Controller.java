...
public class Hl7Controller {
    ...
    @PostMapping(value = { "/Hl7/v2", "/Hl7/v2/" }, consumes = { MediaType.APPLICATION_JSON_VALUE})
    ...
    public Object validateHl7MessageAndForward(
        ...
        return hl7Service.processHl7Message(payload, tenantId,healthCheck, request, response);
    }
}
