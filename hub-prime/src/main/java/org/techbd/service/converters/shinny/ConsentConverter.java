...
public class ConsentConverter extends BaseConverter {
    ...
    public BundleEntryComponent convert(Bundle bundle, DemographicData demographicData,
            List<ScreeningData> screeningDataList, QeAdminData qrAdminData,
            ScreeningResourceData screeningResourceData, String interactionId) {
    ...
    private static void populateConsentStatusAndScope(Consent consent, ScreeningResourceData data) {
    ...
    private static void populateConsentCategory(Consent consent, ScreeningResourceData data) {
    ...
    private void populatePatientReference(Consent consent, ScreeningResourceData screeningResourceData) {
    ...
    private void populateOrganizationReference(Consent consent, ScreeningResourceData screeningResourceData) {
    ...
    private void populateConsentState(Consent consent, ScreeningResourceData screeningResourceData) {
    ...
    private void populateConsentPolicy(Consent consent, ScreeningResourceData screeningResourceData) {
    ...
    private void populateConsentProvision(Consent consent, ScreeningResourceData screeningResourceData) {
    ...
    public static void populateConsentDateTime(Consent consent, ScreeningResourceData screeningResourceData) {
