...
public class EncounterConverter extends BaseConverter {
    ...
    private void populatePatientReference(Encounter encounter, ScreeningResourceData screeningResourceData) {
    ...
    private static void populateEncounterClass(Encounter encounter, ScreeningResourceData data) {
    ...
    private static void populateEncounterType(Encounter encounter, ScreeningResourceData data) {
    ...
    private void populateEncounterStatus(Encounter encounter, ScreeningResourceData screeningResourceData) {
    ...
    private void populateEncounterPeriod(Encounter encounter, ScreeningResourceData screeningResourceData) {
    ...
    private void populateLocationReference(Encounter encounter, ScreeningResourceData screeningResourceData) {
