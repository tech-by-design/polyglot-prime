package org.techbd.csv.service.vfs;
...
public class VfsCoreService {
    ...
    public VfsIngressConsumer createConsumer(
            ...
            Function<VfsIngressConsumer.IngressGroup, Boolean> groupValidator,String masterInteractionId) throws FileSystemException {
        try {
