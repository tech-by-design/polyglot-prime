...
public class FHIRService {
	 ...
	 * @param healthCheck             A flag indicating whether this is a health
	 *                                check request.
	 * @param isSync                  A boolean flag to specify if the request is
	 *                                synchronous.
	 * @param provenance              The provenance information related to the
	 *                                request.
	 ...
	 * @param coRrelationId           The correlation ID used for tracking requests
	 *                                across services
	 */
