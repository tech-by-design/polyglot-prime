...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:name">
      <sch:assert test="count(f:extension[@url = 'http://shinny.org/us/ny/hrsn/StructureDefinition/middle-name']) &lt;= 1">extension with URL = 'http://shinny.org/us/ny/hrsn/StructureDefinition/middle-name': maximum cardinality of 'extension' is 1</sch:assert>
